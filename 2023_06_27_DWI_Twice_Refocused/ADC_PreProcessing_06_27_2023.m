...
% Phantom Position 1 
dicom_list = {{'s000027 fl3d_Twice_Refocus_dur=11'; 's000028 fl3d_Twice_Refocus_dur=11'};
              {'s000029 fl3d_Twice_Refocus_dur=11_delay=20'; 's000030 fl3d_Twice_Refocus_dur=11_delay=20'}; 
              {'s000031 fl3d_Twice_Refocus_dur=11_delay=50'; 's000032 fl3d_Twice_Refocus_dur=11_delay=50'};
              {'s000033 fl3d_Twice_Refocus_dur=11_delay=100'; 's000034 fl3d_Twice_Refocus_dur=11_delay=100'};
              {'s000035 fl3d_Twice_Refocus_dur=11_delay=150'; 's000036 fl3d_Twice_Refocus_dur=11_delay=150'};
              {'s000037 fl3d_Twice_Refocus_dur=11_delay=200'; 's000038 fl3d_Twice_Refocus_dur=11_delay=200'};
              };
...
bg_imge_file = [matdir 'REP2_SOS_TwiRef_d00_TR000_rot0.mat']; 
view_slice = 13; 
radius = 7;
