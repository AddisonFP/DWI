...
% Define directories
datadir = '/v/raid10/users/apowell/2023/2023-06-27_NISTDiffusion/DicomData/'; % the location of the .dcm files that start with 's0000## fl3d...'
workdir = '/v/raid10/users/apowell/DWI/2023_06_27_DWI_NIST_Diffusion/'; % where the proccessed plots are saved (should be the same folder as the one this script is in)
matdir = '/v/raid10/users/apowell/DWI/2023_06_27_DWI_NIST_Diffusion/DicomMats/'; % where the .mat dicom data is saved
cd(workdir);
...
% Phantom Position 1 
dicom_list = {{'s000011 fl3d_SEK05_dur=10'; 's000012 fl3d_SEK05_dur=10'};
              {'s000013 fl3d_SEK05_dur=10_delay=10'; 's000014 fl3d_SEK05_dur=10_delay=10'}; 
              {'s000015 fl3d_SEK05_dur=10_delay=20'; 's000016 fl3d_SEK05_dur=10_delay=20'};
              {'s000017 fl3d_SEK05_dur=10_delay=50'; 's000018 fl3d_SEK05_dur=10_delay=50'};
              {'s000019 fl3d_SEK05_dur=10_delay=100'; 's000020 fl3d_SEK05_dur=10_delay=100'};
              {'s000021 fl3d_SEK05_dur=10_delay=150'; 's000022 fl3d_SEK05_dur=10_delay=150'};
              {'s000023 fl3d_SEK05_dur=10_delay=200'; 's000024 fl3d_SEK05_dur=10_delay=200'};};
...
dicom_dsc = {'SOS_Tri_d00_TR000_rot0'; 
    ...
    'SOS_Tri_d00_TR020_rot0';
    'SOS_Tri_d00_TR050_rot0';
    'SOS_Tri_d00_TR100_rot0';
    'SOS_Tri_d00_TR150_rot0';
    'SOS_Tri_d00_TR200_rot0';};
