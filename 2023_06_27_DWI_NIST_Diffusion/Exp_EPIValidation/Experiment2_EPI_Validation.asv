...
addpath(genpath('/v/raid10/users/apowell/fus-research/DWI/2023_06_27_DWI_NIST_Diffusion/Exp_EPIValidation/'))
...
dicom_lists = {dir([matdir 'REP2_EPI_*.mat']); dir([matdir 'REP2_SOS_*.mat'])};

vials_files = {'REP2_EPI_vials_rot0'; 'REP2_EPI_vials_rot0';};

if ~exist([workdir1 'dwiData2_EPIvials_all.mat'],'file')
    [dwiData, dwiData_table] = getDWIfromDICOMs(vials_files,dicom_lists, false, false, matdir);
    save([workdir1 'dwiData2_EPIvials_all.mat'], 'dwiData', 'dwiData_table'); 
end

%% EXP 1: Create ADC Map
% createADCmap(dicom_lists, 'dwiData2_EPIvials_all.mat', 13, TE_keep, b_keep)
...
slice = 13; 
dwiData_file = [workdir1 'dwiData2_EPIvials_all.mat']; % file that contains all the DWI Signal data (generated in section 1)
