...
if ~exist([workdir1 'dwiDatacomb_EPIvials_all.mat'],'file')
    [dwiData, dwiData_table] = getDWIfromDICOMs(vials_files,dicom_lists, false, false, matdir);
    save([workdir1 'dwiDatacomb_EPIvials_all.mat'], 'dwiData', 'dwiData_table'); 
end
...
slice = 13; 
dwiData_file = [workdir1 'dwiDatacomb_EPIvials_all.mat']; % file that contains all the DWI Signal data (generated in section 1)
